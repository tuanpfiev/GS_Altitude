...
PRED_MAX_ALT = np.zeros(N_REAL_BALLOON)
...
GPS_LOGGER_SOCKET_TIMEOUT = 36000

GPS_UDP_DISTRO_SOCKET = GlobalVariables.GPS_UDP_DISTRO_SOCKET


IMU_LOGGER_SOCKET = GlobalVariables.IMU_READER_SOCKET
IMU_DISTRO_SOCKET = GlobalVariables.IMU_DISTRO_SOCKET
IMU_LOGGER_SOCKET_TIMEOUT = 36000

EKF_LOGGER_SOCKET = GlobalVariables.EKF_OUTPUT_RECEIVE_SOCKET
EKF_LOGGER_SOCKET_TIMEOUT = 36000

EKF_ALL_DISTRO_SOCKET = GlobalVariables.EKF_ALL_DISTRO_SOCKET
N_EKF_NODE_PUBLISH = len(EKF_ALL_DISTRO_SOCKET)

TEMP_LOGGER_SOCKET = GlobalVariables.TEMP_LOGGER_SOCKET
TEMP_LOGGER_SOCKET_TIMEOUT = 36000

RSSI_LOGGER_SOCKET = GlobalVariables.RSSI_LOGGER_SOCKET
RSSI_LOGGER_SOCKET_TIMEOUT = 36000
...
TEMPERATURE_ALL = [TEMPERATURE()] * N_REAL_BALLOON
...
GPS_DATA_BUFFER_UDP_MUTEX = Lock()
...
BREAK_EKF_LOGGER_THREAD = False
BREAK_AWS_GPS_THREAD = False
RECIEVED_EKF_LOCAL_DATA = False
...
BREAK_EKF_LOGGER_THREAD_MUTEX = Lock()
...
EKF_DATA_BUFFER_MUTEX = Lock()
RECIEVED_EKF_LOCAL_DATA_MUTEX = Lock()
EKF_UPDATE_MUTEX = Lock()
BREAK_EKF_ALL_DISTRO_THREAD_MUTEX = Lock()
BREAK_TEMP_LOGGER_THREAD_MUTEX = Lock()
RECIEVED_RSSI_RADIO_DATA_MUTEX = Lock()
RECIEVED_EKF_RADIO_DATA_MUTEX = Lock()

RSSI_ALLOCATION_MUTEX = Lock()
NEXT_PAIR_MUTEX = Lock()
BREAK_RSSI_ALLOCATION_DISTRO_THREAD_MUTEX = Lock()
CURRENT_GPS_DATA_MUTEX = Lock()

GPS_LOG_MUTEX = Lock()
EKF_LOG_MUTEX = Lock()
TEMPERATURE_UPDATE_MUTEX = Lock()

BREAK_PLAYBACK = False
BREAK_PLAYBACK_MUTEX = Lock()

PATH_PREDICTION_MUTEX = Lock()
PATH_PREDICTION = []

PATH_PREDICTION_MSG_MUTEX = Lock()
PATH_PREDICTION_MSG = []


BREAK_PATH_PREDICTION_THREAD_MUTEX = Lock()
BREAK_PATH_PREDICTION_THREAD = False

BREAK_AWS_THREAD_MUTEX = Lock()
BREAK_AWS_THREAD = False

PATH_PREDICTION_RUN_ONCE = False
LOADED_INIT_MESSAGE = False
